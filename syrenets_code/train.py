...
parser.add_argument('-niter','--number_iterations', help='number of training iterations', default=1)
args = parser.parse_args()

train(args.experiment, n_inp=args.number_inputs, depth=args.depth, n_sel=args.number_selection_heads, \
    n_samples=args.number_samples, n_mini_batch=args.number_mini_match, n_iterations=args.number_iterations)